...
type FormData = NoUndefinedField<Pick<Schena, 'price_max' | 'price_min'>>

const priceSchema = schena.pick(['price_min', 'price_max'])
    ...
    <div className='py-4'>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
          ...
          <div className='mt-1 text-red-700 min-h-[1.25rem] text-center'>{errors.price_min?.message}</div>
